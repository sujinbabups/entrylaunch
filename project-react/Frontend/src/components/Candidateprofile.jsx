        ...
        <form onSubmit={submitForm} className="space-y-4">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
            <div className="flex-1">
              ...
              <input required type="text" name="name" value={fullname} id="name" className="block w-full md:w-3/5 px-2 py-1 border rounded text-black" readOnly />
            </div>
            <div className="flex-1">
              <label htmlFor="email" className="block mb-2">Email :</label>
              <input type="email" required name="email" id="email" value={user.email} className="block w-full md:w-3/5 px-2 py-1 border rounded text-black" readOnly />
            </div>
          </div>
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4">
            <div className="flex-1">
              <label htmlFor="dob" className="block mb-2">D.o.b :</label>
              <input required type="date" name="dob" id="dob" value={dob} onChange={(e) => setDob(e.target.value)} className="block w-full md:w-3/5 px-2 py-1 border rounded text-black" />
            </div>
            <div className="flex-1">
              <label htmlFor="place" className="block mb-2">Place :</label>
              <input required type="text" name="place" id="place" value={place} onChange={(e) => setPlace(e.target.value)} className="block w-full md:w-3/5 px-2 py-1 border rounded text-black" />
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <input type="reset" value="Reset" className="bg-blue-800 text-white py-2 px-4 rounded cursor-pointer" onClick={resetForm} />
          </div>
        </form>
      </div>
    </>
